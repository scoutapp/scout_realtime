...
function sizeRightColumn(){
  console.debug("sizing right column")
  $(".right_column").css("width",$(document).width()-250+"px");
}
$(window).resize(function() { sizeRightColumn(); });
$(document).ready(sizeRightColumn);